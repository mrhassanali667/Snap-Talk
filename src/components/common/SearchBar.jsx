...
const SearchBar = () => {
  return (
    <div className='h-[45px] w-full flex pr-2 bg-slate-200/70 dark:bg-gray-600/50 rounded-[3px]'>
        ...
        <input type="search"
        className='w-auto grow h-full bg-transparent outline-none border-none text-zinc-700 dark:text-zinc-300  ml-2 placeholder:text-zinc-400'
        placeholder='Search'
         /> 
    </div>
  )

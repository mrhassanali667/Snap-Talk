            ...
            <div className='h-full w-full '>
                <div className='flex justify-center bg-violet-50'>
                    ...
                    <div className='w-full max-w-[440px] flex gap-1 p-[10px] flex-col justify-center items-center'>
                        ...
                        <div className='h-[70px] w-full flex flex-col gap-2 justify-center items-center text-neutral-600'>
                            <p className='text-[0.9em]'>Want to leave <button onClick={logoutUser} className='text-indigo-600 cursor-pointer '>Logout</button></p>

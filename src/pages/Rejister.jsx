            ...
            <div className='flex flex-col gap-3 h-[665px] w-full  max-w-[430px] '>
                <div className=''>
                    ...
                    <div className='h-[80px] w-full flex flex-col justify-center items-center'>
                        ...
                        <p className='text-[0.9em] text-neutral-600'>Get your Chatvia account now.</p>
                    </div>
                </div>
                ...
                <div className='h-[150px] w-full flex flex-col gap-2 justify-center items-center text-neutral-600'>
                    <p className='text-[0.9em]'>Don't have an account ? <Link to={'/login'} className='text-indigo-600'>Signip</Link></p>
                    <p className='text-[0.9em]'>© {new Date().getFullYear()} Chatvia. Crafted with  by 	<span className='text-red-600 text-[1.5em]'>&hearts;</span> Hassan Ali</p>
                </div>
            </div>
        </div >
    )
